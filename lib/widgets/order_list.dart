            ...
            children: widget.client.orders!.map<ExpansionPanel>((Order item) {
              return ExpansionPanel(
                ...
                body: Stack(
                  children: [
                    ListTile(
                      title: Text('Fecha: ${item.orderDate}', style: const TextStyle( color: Colors.black87, fontSize: 15, fontWeight: FontWeight.bold)),
                      subtitle:
                          Text('Comentario: ${item.comment}', style: const TextStyle( color: Colors.black54, fontSize: 15)),
